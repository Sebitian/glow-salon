  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <p className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 via-amber-400 to-amber-500 mb-3">
      ...
      <div className="space-y-4">
        {instagramAccounts.map((account) => (
          ...
          >
            ...
            <span className="text-xl text-white underline underline-offset-4 decoration-2 decoration-amber-400 group-hover:decoration-amber-300 transition-colors">
              {account.handle}
            </span>
          </Link>
        ))}
